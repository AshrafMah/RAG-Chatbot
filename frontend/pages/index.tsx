...
export const apiHost = process.env['SWIFT_ENDPOINT'] || 'http://localhost:8000';
      ...
      <div className="flex flex-col w-full items-start">
        <div className="mb-4">
          <div className="flex text-lg">
            ...
            <span className="bg-blue-200 rounded px-2 py-1 hover-container animate-pop-more-late">
              RAGtriever
            </span>
          </div>
